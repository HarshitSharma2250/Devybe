...
struct User {
    first_name: Box<Option<String>>,
    last_name: Box<Option<String>>,
    telegram_id: Box<String>,
    avatar: Box<Option<String>>,
    role: Box<String>,
    is_blocked: Box<bool>,
    blocked_by: Box<Option<candid::Principal>>,
    selected_categories: Box<Vec<String>>,
    selected_events: Box<Vec<String>>,
    avatar_public_id: Box<Option<String>>,
}
#[derive(
    serde :: Deserialize,
    Debug,
